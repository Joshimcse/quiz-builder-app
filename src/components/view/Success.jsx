  ...
  return (
    quizResult && (
      <div className="w-full h-screen flex flex-col items-center justify-center">
        ...
        <h2 className=" text-24 text-green-500 font-bold mb-3">
        ...
        <Link to="/">
          <button className="text-14 w-48 font-bold uppercase text-white bg-green-600 mt-4 flex flex-row items-center justify-center p-2 rounded">
            Goto Dashboard
          </button>
        </Link>
